...
public class BranchController {
	...
	@ApiResponses(value={@ApiResponse(code=201,message = "Updates Succesfully"),@ApiResponse(code = 404,message = "ID not found")})
	...
	@ApiOperation(value = "Branch",notes="API is used to update branch")
